        ...
        <Block_Spacing>
            ...
            <Block_Button>
                <Button variant='contained'endIcon={<SaveIcon />} onClick={async () => {
                    ...
                    params.ReceiveIssueDate = convertDatetime(document.getElementById('dp_IsssueDate_TransferByAccount').value)
                    params.ReceiveIssuePlace = document.getElementById('txt_IssuePlace_TransferByAccount').value;
                    params.ReceivePhone = document.getElementById('txt_Phone_TransferByAccount').value;
                    params.BankName = document.getElementById('txt_BankName_TransferByAccount').value;
                    ...
                    params.WaiveCharge = resolveNameID(Close_Online, document.getElementById('slt_WaiveCharges_TransferByAccount').innerText);
                    params.Province = resolveNameID(cityList, document.getElementById('slt_Province_TransferByAccount').innerText)
                    params.BankCode = resolveNameID(BankCode, document.getElementById('slt_BankCode_TransferByAccount').innerText)
