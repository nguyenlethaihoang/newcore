...
function CloseAccount_Components01({suffixID, forceDisable}) {
// Manage Disable
        ...
        <div>
          <Box m={2}>
           ...
           <Block_Children>
                ...
                <TextField_Value id={'txt_WorkingBallance_'+suffixID} label='WorkingBallance' length='30' disabled={true}/>
                ...
                <TextField_Value id={'txt_TotalCreditInterest_'+suffixID} label='Total Credit Interest' length='30' disabled={true}/>
