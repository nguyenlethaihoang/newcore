...
function SavingAccount_OpenPeriodic_Components01({suffixID, forceDisable, object}) {
    // Manage Disable
...
<div>
    <Box m={2}>
        <Block_Children> 
                ...
                <TextField_Value id={'txt_ShortTitle_'+suffixID} label='Short Title' length='20' disabled={isDisabled} value={object.ShortTitle}/>
                ...
                <Select_Object id={'slt_ProductLine_'+suffixID} label='Product Line' object={ProductLine_SavingAccount}length='40' disabled={isDisabled} dataID={object.ProductLine}/>
        </Block_Children>
        <Block_Children header2='JOIN ACCOUNT INFOMATION'>
                ...
                <TextField_Value id={'txt_Notes_'+suffixID} label='Notes' length='20' disabled={isDisabled} value={object.Notes}/>
        </Block_Children>
    </Box>
</div>
); 
...
export default SavingAccount_OpenPeriodic_Components01;