...
function SavingAccount_OpenArrear_Components01({suffixID, forceDisable, object}) {
    // Manage Disable
...
<div>
    <Box m={2}>
        ...
        <Block_Children header2='JOIN ACCOUNT INFOMATION'>
                ...
                <Select_Object id={'slt_Relationship_'+suffixID} label='Relationship'object={relationCodeList}length='30' disabled={isDisabled} dataID={object.RelationShip}/>
                <TextField_Value id={'txt_Notes_'+suffixID} label='Notes' length='20' disabled={isDisabled} value={object.AccountTitle}/>
                <Select_Object id={'slt_AccountOfficer_'+suffixID} label='Account Officer'object={accountOfficerList}length='30' disabled={isDisabled} dataID={object.AccountOfficer}/>
