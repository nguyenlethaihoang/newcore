...
function CorporateCustomer_Components({suffixID, forceDisable}) {
// Manage Disable
...
const [specificCustomerList, setSpecificCustomerList] = useState([]);
    return ( 
        ...
        >
                    ...
                    <Block_Children>
                            <TextField_Value id={'txt_GBShortName_'+suffixID} label='GB Short Name' length='30' required={true} disabled={isDisabled}/>
                            <TextField_Value id={'txt_GBFullName_'+suffixID} label='GB Full Name' length='30' required={true} disabled={isDisabled}/>
                            <DataPicker_Day id={'dp_IncorpDate_'+suffixID} label='Incorp Date' disabled={isDisabled}/>
                    </Block_Children>
                    ...
                    <Block_Children>
                            ...
                            <DataPicker_Day id={'dp_DocIssuePlace_'+suffixID} label='Doc Issue Place' disabled={isDisabled}/>
                    ...
                    <Block_Children>
                            <TextField_Value id={'txt_ContactPerson_'+suffixID}  label='Contact Person' length='23' disabled={isDisabled}/>
                            <TextField_Value id={'txt_Position_'+suffixID}  label='Position' length='23' disabled={isDisabled}/>
                            <TextField_Value id={'txt_Telephone_'+suffixID } label='Telephone' length='15' disabled={isDisabled}/>
                            <TextField_Value id={'txt_EmailAddress_'+suffixID } label='Email Address' length='30' disabled={isDisabled}/>
                            <TextField_Value id={'txt_Remarks_'+suffixID}  label='Remarks' length='30' disabled={isDisabled}/>
                    </Block_Children>
                    {/* Block 4 - 1.2 Open Corporate Customer */}
                    <Block_Children>
                            <Select_Object id={'slt_MainSector_'+suffixID} label='Main Sector'required={true} object={mainSectorList}length='25' disabled={isDisabled}/>
                            <Select_Object id={'slt_SubSector_'+suffixID} label='Sub Sector'required={true} object={subSectorList}length='25' disabled={isDisabled}/>
                            <Select_Object id={'slt_MainIndustry_'+suffixID} label='Main Industry'object={mainIndustryList}length='25' disabled={isDisabled}/>
                            <Select_Object id={'slt_Industry_'+suffixID} label='Industry'object={industryList}length='25' disabled={isDisabled}/>
