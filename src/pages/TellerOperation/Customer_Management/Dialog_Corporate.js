  ...
  return (
    <div>
      ...
      >
        ...
        {(isDisabledDialog) && <CorporateCustomer_Components suffixID={'OpenIndividual_Popup'} forceDisable={isDisabledDialog}/>}
        {(!isDisabledDialog) && <CorporateCustomer_Components suffixID={'OpenIndividual_Popup'} forceDisable={false}/>}
      </Dialog>
    </div>
  );
}